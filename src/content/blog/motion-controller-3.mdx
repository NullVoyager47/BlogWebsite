...
Next time I will be preparing the blaster shell, so that I can determine the exact positioning of components so that I can create a functional prototype.