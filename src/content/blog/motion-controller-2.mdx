...
This diagram shows how the gyroscope will connect to the pro micro. The vcc and ground pins will obviously connect to the vcc and ground of the pro micro. The SCL on the MPU6050 connects to the digital 3 pin on the pro micro, and the SDA connects to digital 2. 
